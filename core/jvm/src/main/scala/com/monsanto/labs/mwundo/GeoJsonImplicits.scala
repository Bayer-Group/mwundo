...
object GeoJsonImplicits {
  ...
  /**
    ...
    * @tparam P
    */
  implicit class RichGeoJsonFeatureCollection[G <: GeoJson.Geometry: JTSGeoFormat: GeoTransformer, P](
  ...
  /**
    ...
    * @tparam G
    */
  implicit class RichGeoJsonGeometry[G: JTSGeoFormat: GeoTransformer](val geometry: G) extends GeometryOps[G](geometry)
  ...
  abstract class GeometryOps[G: GeoTransformer: JTSGeoFormat](geometry: G) {
    ...
    /**
      ...
      * @return
      */
    def boundingBoxAreaKmSq(r: Double = meanRadiusOfEarth): Double =
      Utils.latLongRectangleArea(minLat, minLong, maxLat, maxLong, r)
