...
object GeoJsonFormats extends DefaultJsonProtocol {
  ...
  implicit def GeometryCollectionFormat[G <: Geometry] (implicit gFmt: JsonFormat[G]): RootJsonFormat[GeometryCollection[G]] =
  ...
  implicit def FeatureFormat[G <: Geometry, P] (implicit gFmt: JsonFormat[G], pFmt: JsonFormat[P]): RootJsonFormat[Feature[G, P]] =
  ...
  implicit def FeatureCollectionFormat[G <: Geometry, P] (implicit fFmt: JsonFormat[Feature[G, P]]): RootJsonFormat[FeatureCollection[G, P]] =
